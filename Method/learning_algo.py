...
from Method.model import build_DOSSL
...
class LearningAlgorithm():
    ...
    def __init__(self,count,lambda_1,lambda_2,lambda_3,beta,beta2,config_file,num_features_nonzero_list):
        ...
        if cudastatus=='True':
            ...
            self.device='cpu'
        # Build model
        self.model = build_DOSSL(cfg=self.cfg,z_dim=self.z_dim,num_features_nonzero_list=num_features_nonzero_list, device=self.device)
