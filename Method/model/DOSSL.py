...
def build_DOSSL(cfg, z_dim,num_features_nonzero_list, device='cuda'):
    ...
    # Build model
    model =DOSSL(num_features_nonzero_list=num_features_nonzero_list,cfg=cfg, input_dim=input_dim, x_dim=x_dim, num_class=num_class, z_dim=z_dim, activation=activation,
                  dense_x_h=dense_x_h,
